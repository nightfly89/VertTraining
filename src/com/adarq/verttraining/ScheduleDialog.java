...
public class ScheduleDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
        // Use the Builder class for convenient dialog construction
		        ...
		        builder.setMessage(R.string.scheduleTitle);
			               ...
			               public void onClick(DialogInterface dialog, int id) {
			            	  ...
			            	  if( et1.getText().toString().length() == 0 ){
			            		...
			            		//Updating the list
			            				   ...
			            				   ex = Training.datasource.duplicateSchedule();
			            				   ...
			            				   if (exists == false){
			            				   Training.datasource.createSchedule(name);
			            				   }
			            				   else{
			            					   Toast.makeText(Training.trainingActivity.getApplicationContext(),"Schedule already exists",Toast.LENGTH_SHORT).show();
			            				   }
			            				   Training.datasource.close();  
			            				   
			            				   in = new Intent(Training.trainingActivity.getApplicationContext(), LoadSchedule.class);
			           					   startActivity(in);
